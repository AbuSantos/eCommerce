...
const PaymentOptions = ({ handleSubmit }) => {
    ...
    const renderPaymentButton = () => {
        if (selectedOption === "paystack") {
            return (
                <PaystackPayment handleSubmit={handleSubmit} />
            );
