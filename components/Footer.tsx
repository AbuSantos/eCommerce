...
const Footer = () => {
    ...
    return (
        <div className="bg-yellow-600 p-5 text-gray-800">
            <div className="grid grid-cols-2 mx-auto  max-w-7xl">
                <div className="logo">
                    logo
                </div>
                <div className="content">
                    <h1 className="font-semibold p-2 text-xl ">Subsribe to our newsletter to get early access to our latest and exclusive designs</h1>
                </div>

            </div>
            <main className="grid md:grid-cols-2 mx-auto max-w-7xl text-sm rounded-lg ">
                <div className={`${openSans.className} p-2`}>
                    <p >RuthRich Designs</p>
                    <p className="flex">
